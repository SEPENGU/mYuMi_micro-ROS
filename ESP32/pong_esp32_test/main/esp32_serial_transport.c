...
#define UART_TXD  -1 //(CONFIG_MICROROS_UART_TXD)
#define UART_RXD  -1 //(CONFIG_MICROROS_UART_RXD)
#define UART_RTS  -1 //(CONFIG_MICROROS_UART_RTS)
#define UART_CTS  -1 //(CONFIG_MICROROS_UART_CTS)
